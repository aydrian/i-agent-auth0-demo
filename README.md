...
See [`docs/demos/ciba-watchlist.md`](docs/demos/ciba-watchlist.md) for the live demo runbook, [`docs/demos/camp-ai-ny.md`](docs/demos/camp-ai-ny.md) for the 5-minute Camp AI NY runbook (identity + Token Vault + CIBA combined), [`docs/auth0-ciba-without-chat.md`](docs/auth0-ciba-without-chat.md) for the SDK-in-cron postmortem, [`docs/superpowers/specs/2026-05-26-ciba-price-watchlist-design.md`](docs/superpowers/specs/2026-05-26-ciba-price-watchlist-design.md) for the full design spec, and [`docs/superpowers/plans/2026-05-26-ciba-watchlist.md`](docs/superpowers/plans/2026-05-26-ciba-watchlist.md) for the step-by-step implementation plan.
